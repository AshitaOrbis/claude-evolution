...
- **OpenClaw Agent Operational Patterns** *(local-only — `techniques/openclaw-agent-operational-patterns-2026-03-07.md`; held back by the publish scanner)* — Extracted patterns from 130+ hour autonomous Claude-in-Docker agent: tiered autonomy, runaway loop detection, stagnation protocol, capability lifecycle, sub-agent verification, small diff doctrine. Tags: `openclaw`, `autonomous-agent`, `operational-patterns`, `self-governance`, `anti-patterns`
